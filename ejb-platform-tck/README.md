...
`mvn clean verify -Ppayara-server-managed -pl . -pl ejb-platform-tck`

Alternatively, execute against a remote server:

`mvn clean verify -Ppayara-server-remote -pl . -pl ejb-platform-tck -Dpayara.home=/path/to/payara7`
