 ...
 *  holder.
 */
package fish.payara.server.tck.jsonp.propertyextension;
...
public class ArchiveProcessor implements ApplicationArchiveProcessor {
    ...
    public Properties filterSystemProperties() {
        ...
        for (Map.Entry<Object, Object> entry: sysProps.entrySet())
        {
            ...
            if (entry.getKey().equals("optional.tech.packages.to.ignore")) {
                filteredProps.put("optional.tech.packages.to.ignore", entry.getValue());
            }
        }
