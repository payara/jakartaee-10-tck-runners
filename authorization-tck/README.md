...
From the top-level directory: `mvn clean install -pl . -pl tck-download -pl tck-download/jakarta-authorization-tck`
...
* Install the common TCK module (make sure you don't clean!): `mvn install -Ppayara-server-remote -pl . -pl common -DskipTests`
...
* Run your specific TCK module test (make sure you don't clean!), for example: `mvn verify -Ppayara-server-remote -f app-custom-policy2 -Dit.test=AppCustomPolicy2IT#testAuthenticatedSpecial`
