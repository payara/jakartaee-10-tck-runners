...
if [[ "$PROFILE" == "web" || "$PROFILE" == "WEB" ]];then
  mvn clean verify surefire-report:report -Pcustom,old-tck,web,\!glassfish-ci-managed -f target/authentication-tck-${VERSION}/tck/pom.xml -Dpayara.artifact=payara-web
else
