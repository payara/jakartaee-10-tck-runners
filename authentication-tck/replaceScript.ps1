...
Set-Content .\target\authentication-tck-3.1.0\tck\spi\soap\src\main\resources\META-INF\services\com.sun.xml.ws.assembler.metro.dev.ClientPipelineHook "com.sun.enterprise.security.webservices.ClientSecurityPipeCreator"
